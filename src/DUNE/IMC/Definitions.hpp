...
namespace DUNE
{
  namespace IMC
  {
    ...
    public:
      ...
      getVariableSerializationSize(void) const
      {
        return checkOptBit(0)*1 + checkOptBit(1)*1 + IMC::getSerializationSize(opmodes)*checkOptBit(2);
      }
    ...
    public:
      ...
      getVariableSerializationSize(void) const
      {
        return checkOptBit(0)*4 + checkOptBit(1)*4 + checkOptBit(2)*4 + checkOptBit(3)*2 + checkOptBit(4)*2 + checkOptBit(5)*2 + checkOptBit(6)*2 + checkOptBit(7)*1 + checkOptBit(8)*1 + checkOptBit(9)*2;
      }
